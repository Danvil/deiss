...
impl ModeBlueprintLibrary {
    pub fn new(disp_bits: u32, g: &mut Globals) -> Self {
        ...
        mode_info.insert(
            ...
            ModeBlueprint {
                ...
                tf_gen: Box::new(|rand: &mut _| DitherTurnScaleTransform::mode_1(rand).into()),
            },
        );
        ...
        mode_info.insert(
            ...
            ModeBlueprint {
                ...
                effect_count: [1, 5],
                motion_dampened: true,
                tf_gen: Box::new(|rand: &mut _| TurnScaleTransform::mode_2(rand).into()),
            },
        );
        ...
        mode_info.insert(
            ...
            ModeBlueprint {
                ...
                tf_gen: Box::new(|rand: &mut _| TurnScaleTransform::mode_3(rand).into()),
            },
        );
        ...
        for (_, mi) in mode_info.iter_mut() {
            if disp_bits > 8 {
                ...
                mi.effect_freq[EffectKind::Dots] =
                    (mi.effect_freq[EffectKind::Dots] + 220).min(900);
                mi.effect_freq[EffectKind::Bar] = (mi.effect_freq[EffectKind::Bar] + 220).min(900);
                mi.effect_freq[EffectKind::Shade] =
                    (mi.effect_freq[EffectKind::Shade] + 150).min(900);
            }
